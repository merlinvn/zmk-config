...
hypergolic: zmk fresh
	$(call _build,nice_nano_v2,cradio_left,Hypergolic)

hypergolic-peripheral: zmk fresh
	$(call _build,nice_nano_v2,cradio_right,Hypergolic-P)

corne: zmk fresh
	$(call _build,nice_nano_v2,corne_left,Corne)

corne-peripheral: zmk fresh
	$(call _build,nice_nano_v2,corn_right,Corne-P)
...
adux: zmk fresh
	$(call _build,nice_nano_v2,architeuthis_dux_left,Architeuthis\ Dux)

adux-peripheral: zmk fresh
	$(call _build,nice_nano_v2,architeuthis_dux_right,A.\ Dux-P)
