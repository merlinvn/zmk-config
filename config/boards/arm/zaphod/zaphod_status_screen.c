...
lv_obj_t *zmk_display_status_screen() {
  ...
  /* lv_style_set_bg_color(&global_style, LV_STATE_DEFAULT, */
  /*                       LV_COLOR_WHITE); // Set the background color to white
   */
  /* lv_style_set_text_color(&global_style, LV_STATE_DEFAULT, */
  /*                         LV_COLOR_BLACK); // Set the text color to black */
